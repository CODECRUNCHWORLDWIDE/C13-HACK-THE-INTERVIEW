...
```mermaid
flowchart LR
  Resume["Resume PDF"] --> Parse["Parse into fields"]
  Parse --> Tag["Tag by keywords"]
  Tag --> Rank["Rank against job description"]
  Rank --> Route["Route to recruiter queue"]
```
*What the ATS does to your resume before any human ever sees it.*
