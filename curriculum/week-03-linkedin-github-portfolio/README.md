...
| [resources.md](./resources.md) | LinkedIn search references, GitHub README templates, portfolio examples |
| [lecture-notes/01-the-linkedin-profile-recruiters-read.md](./lecture-notes/01-the-linkedin-profile-recruiters-read.md) | Headline, About, Experience, Skills — and what LinkedIn Recruiter searches |
| [lecture-notes/02-the-github-profile-that-tells-a-story.md](./lecture-notes/02-the-github-profile-that-tells-a-story.md) | Profile README, pinned repos, project READMEs, activity hygiene |
| [exercises/README.md](./exercises/README.md) | Three exercises |
| [exercises/exercise-01-rewrite-headline-and-about.md](./exercises/exercise-01-rewrite-headline-and-about.md) | Rewrite your LinkedIn headline and About from scratch |
| [exercises/exercise-02-pin-three-best-repos.md](./exercises/exercise-02-pin-three-best-repos.md) | Curate and pin three repos to your GitHub profile |
| [exercises/exercise-03-readme-for-your-top-project.md](./exercises/exercise-03-readme-for-your-top-project.md) | Write a real README for the strongest of your three pinned repos |
| [challenges/README.md](./challenges/README.md) | One stretch challenge |
| [challenges/challenge-01-the-recruiter-skim-test.md](./challenges/challenge-01-the-recruiter-skim-test.md) | Have two peers click through your name → LinkedIn → GitHub and report what they saw |
| [quiz.md](./quiz.md) | 10 MCQs |
| [homework.md](./homework.md) | Six problems (~6h) |
| [mini-project/README.md](./mini-project/README.md) | Polished public LinkedIn + GitHub presence, peer-reviewed |
