...
When both lectures are clear, the [exercises](../03-exercises/00-overview.md) take you from "current LinkedIn + GitHub" to "the polished version that a recruiter and a hiring manager will read with respect."
