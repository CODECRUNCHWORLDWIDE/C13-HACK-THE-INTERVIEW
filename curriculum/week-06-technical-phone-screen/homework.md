...
After homework, the [mini-project](./mini-project/README.md) records a full mock technical phone screen using a shared editor and walks the scoring rubric over the playback.
