...
When you can narrate the five phases on a fresh easy problem without notes, move to the exercises. [Exercise 2 — Narrate on CoderPad](../03-exercises/exercise-02-narrate-coderpad.md) is the highest-leverage solo drill of the week; do it before the pair mock in Exercise 1.
